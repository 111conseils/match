                                  ...
                                  {!existingProcess ? (
                                    <div className="flex gap-2">
                                      ...
                                      <Button 
                                        size="icon"
                                        className="h-10 w-10 rounded-full bg-green-600 hover:bg-green-700 text-white"
                                        onClick={() => acceptMatch(selectedCandidat, match.poste)}
                                        data-testid={`accept-match-poste-${match.poste.id}`}
                                        title="Accepter et créer un process"
                                      >
                                        <Check className="h-5 w-5" />
                                      </Button>
                                    ...
                                    <Button size="sm" variant="outline" onClick={() => openProcessModal(selectedCandidat, match.poste)}>
                                      Voir détails
                                    </Button>
                                  )}
                                </div>
